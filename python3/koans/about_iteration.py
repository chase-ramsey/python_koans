...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Me: it reduces all items in a list to a single value by performing
        #     an operation on the first two items that combines them into one,
        #     and repeating that operation until one value is the result.
